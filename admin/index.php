...
<!-- /.row -->
  <?php  
   $query = "SELECT * FROM posts WHERE post_status = 'published'";
	...
	$unapproved_commets_query = mysqli_query($connection,$query);
	$unapproved_comment_counts = mysqli_num_rows($unapproved_commets_query);
  ...
  ?>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
		  ...
		  $element_count = [$post_counts, $post_published_counts, $post_draft_counts, $comments_count, $unapproved_comment_counts, $user_counts, $subscriber_counts, $category_counts];
		 for($i = 0; $i < 8; $i++){
